...
const HoctapScreen: React.FC = () => {
  ...
  const fetchHoctapNotes = async () => {
    try {
      setLoading(true);
      const response = await fetch(`${API_URL}/api/articles?type=hoctap`);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <Text style={styles.title}>🎓 Ghi chú học tập</Text>
      </View>
